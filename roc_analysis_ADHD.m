...
adhd_result=importdata('ADHD_result.txt');
...
legend('Size (AUC=0.80)','SampEn (AUC=0.71)','TranEn (AUC=0.62)','Location','SouthEast');
...
legend('Size and SampEn (AUC=0.82)','Size and TranEn (AUC=0.84)','Location','SouthEast');
